...
test_that("lsm_l_rpr is typestable", {
    expect_s3_class(lsm_l_rpr(landscape, classes_max = 5), "tbl_df")
    expect_s3_class(lsm_l_rpr(landscape_stack, classes_max = 5), "tbl_df")
    expect_s3_class(lsm_l_rpr(landscape_list, classes_max = 5), "tbl_df")
})
