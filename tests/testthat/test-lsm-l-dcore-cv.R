...
test_that("lsm_l_dcore_cv is typestable", {
    expect_s3_class(lsm_l_dcore_cv(landscape), "tbl_df")
    expect_s3_class(lsm_l_dcore_cv(landscape_stack), "tbl_df")
    expect_s3_class(lsm_l_dcore_cv(landscape_list), "tbl_df")
})
