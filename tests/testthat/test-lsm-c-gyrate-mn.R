...
test_that("lsm_c_gyrate_mn is typestable", {
    expect_s3_class(lsm_c_gyrate_mn(landscape), "tbl_df")
    expect_s3_class(lsm_c_gyrate_mn(landscape_stack), "tbl_df")
    expect_s3_class(lsm_c_gyrate_mn(landscape_list), "tbl_df")
})
