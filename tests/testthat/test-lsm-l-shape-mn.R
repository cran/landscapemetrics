...
test_that("lsm_l_shape_mn is typestable", {
    expect_s3_class(lsm_l_shape_mn(landscape), "tbl_df")
    expect_s3_class(lsm_l_shape_mn(landscape_stack), "tbl_df")
    expect_s3_class(lsm_l_shape_mn(landscape_list), "tbl_df")
})
