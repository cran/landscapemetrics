...
#'
#' @export
lsm_c_dcore_mn <- function(landscape, directions, consider_boundary, edge_depth) UseMethod("lsm_c_dcore_mn")

#' @name lsm_c_dcore_mn
#' @export
lsm_c_dcore_mn.RasterLayer <- function(landscape, directions = 8, consider_boundary = FALSE, edge_depth = 1) {
...
#' @name lsm_c_dcore_mn
#' @export
lsm_c_dcore_mn.RasterStack <- function(landscape, directions = 8, consider_boundary = FALSE, edge_depth = 1) {
...
#' @name lsm_c_dcore_mn
#' @export
lsm_c_dcore_mn.RasterBrick <- function(landscape, directions = 8, consider_boundary = FALSE, edge_depth = 1) {
...
#' @name lsm_c_dcore_mn
#' @export
lsm_c_dcore_mn.stars <- function(landscape, directions = 8, consider_boundary = FALSE, edge_depth = 1) {
...
#' @name lsm_c_dcore_mn
#' @export
lsm_c_dcore_mn.list <- function(landscape, directions = 8, consider_boundary = FALSE, edge_depth = 1) {
