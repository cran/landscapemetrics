...
#'
#' @export
lsm_l_dcore_cv <- function(landscape, directions) UseMethod("lsm_l_dcore_cv")

#' @name lsm_l_dcore_cv
#' @export
lsm_l_dcore_cv.RasterLayer <- function(landscape, directions = 8) {
...
#' @name lsm_l_dcore_cv
#' @export
lsm_l_dcore_cv.RasterStack <- function(landscape, directions = 8) {
    purrr::map_dfr(raster::as.list(landscape),
                   lsm_l_dcore_cv_calc,
                   directions = directions,
                   .id = "layer") %>%
...
#' @name lsm_l_dcore_cv
#' @export
lsm_l_dcore_cv.RasterBrick <- function(landscape, directions = 8) {
    purrr::map_dfr(raster::as.list(landscape),
                   lsm_l_dcore_cv_calc,
                   directions = directions,
                   .id = "layer") %>%
...
#' @name lsm_l_dcore_cv
#' @export
lsm_l_dcore_cv.list <- function(landscape, directions = 8) {
...
lsm_l_dcore_cv_calc <- function(landscape, directions){
