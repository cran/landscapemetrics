...
#'
#' @export
lsm_l_dcore_sd <- function(landscape, directions) UseMethod("lsm_l_dcore_sd")

#' @name lsm_l_dcore_sd
#' @export
lsm_l_dcore_sd.RasterLayer <- function(landscape, directions = 8) {
...
#' @name lsm_l_dcore_sd
#' @export
lsm_l_dcore_sd.RasterStack <- function(landscape, directions = 8) {
    purrr::map_dfr(raster::as.list(landscape),
                   lsm_l_dcore_sd_calc,
                   directions = directions,
                   .id = "layer") %>%
...
#' @name lsm_l_dcore_sd
#' @export
lsm_l_dcore_sd.RasterBrick <- function(landscape, directions = 8) {
    purrr::map_dfr(raster::as.list(landscape),
                   lsm_l_dcore_sd_calc,
                   directions = directions,
                   .id = "layer") %>%
...
#' @name lsm_l_dcore_sd
#' @export
lsm_l_dcore_sd.list <- function(landscape, directions = 8) {
...
lsm_l_dcore_sd_calc <- function(landscape, directions){
